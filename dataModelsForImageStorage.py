...
SQLALCHEMY_DATABASE_URI = 'mysql://root:FdtWeb2013@localhost/finalYearProject'
...
class SkinImage(object):
    def __init__(self, patientAge=None, patientLocation=None, skinConditionDescription=None, skinImageName=None,
                 skinImageExtension=None, skinImageId=None):
